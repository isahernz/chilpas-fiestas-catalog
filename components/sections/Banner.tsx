...
export function Banner() {
  return (
    <div className="relative w-full">
      <Card className="w-full overflow-hidden border-0 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-700 text-white">
        ...
        <CardContent className="relative space-y-6 p-12 text-center">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Link
              ...
              className="group flex rounded-2xl bg-white px-4 py-2 text-sm font-semibold text-purple-600 hover:bg-gray-50"
            >
